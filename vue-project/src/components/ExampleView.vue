<template>
  <v-app class="hero">
    <v-overlay v-model="overlay" width="100%" height="100%" persistent>
      <v-overlay v-model="overlay" width="100%" height="100%" persistent>
        <v-overlay v-model="overlay" width="100%" height="100%" persistent>
          <v-container class="fill-height fill-width" @click.stop :style="{ position: 'relative' }">
            ...
            <v-row class="d-flex">
              ...
              <v-col cols="4" class="mx-auto">
                ...
                <div v-if="page != 6">
                  <v-progress-linear class="overlayedbar" height="20vh" color="grey" v-model="totalTimer">
                  </v-progress-linear>
                </div>
              </v-col>
            </v-row>
            <v-row>
              ...
              <v-col cols="4">
                <div v-if="page == 4">
                  <v-img class="mx-auto" src="../assets/img_timer.jpg" width="25vw" />
                </div>
                <div v-else class="mx-auto">
                  <v-img class="mx-auto" src="../assets/img_timer_overlayed.jpg" width="25vw" />
                </div>
              </v-col>
              <v-spacer></v-spacer>
            </v-row>
            ...
            <v-row class="justify-center" :style="{ 'margin-top': '7vh', 'font-size': '1vh' }">
              <v-col cols="4">
                <v-text-field v-if="page == 5" readonly bg-color="white" label="answer" single-line
                  density="compact"></v-text-field>
                <v-text-field v-if="page != 5" readonly label="answer" single-line density="compact"></v-text-field>
              </v-col>
            </v-row>
            <div v-if="page == 1" :style="{ 'font-size': '3vh', color: 'white' }" class="text-center">
              게임 화면의 구성을 설명합니다.<br />
            ...
            <div v-if="page == 3" :style="{ 'font-size': '3vh', color: 'white', position: '' }" class="text-center">
            ...
            <div v-if="page == 4" :style="{ 'font-size': '3vh', color: 'white' }" class="text-center">
              3. 이미지의 완성도입니다.<br />
            ...
            <div v-if="page == 5" :style="{ 'font-size': '3vh', color: 'white' }" class="text-center">
            ...
            <div v-if="page == 6" :style="{ 'font-size': '3vh', color: 'white' }" class="text-center">
              5. 남은 물감의 총량입니다.<br />
